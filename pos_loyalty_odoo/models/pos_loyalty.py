...
class res_partner(models.Model):
	...
	loyalty_points1 = fields.Float(string='Loyalty Points',compute='_compute_loyalty_points',store=True)
...
class pos_category(models.Model):
	...
	Minimum_amount  = fields.Float("Amount For loyalty Points")
	amount_footer = fields.Float('Amount', related='Minimum_amount')
...
class pos_loyalty_history(models.Model):
	...
	points = fields.Float('Loyalty Points')
